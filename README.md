...
Forward incoming mail for a certain user to this script by creating a line like the following in `/etc/aliases` :  
```
$ cat /etc/aliases
# See man 5 aliases for format
postmaster:    root
# The next line forwards all mail received by user "calbot" to calbot-mail.py.
